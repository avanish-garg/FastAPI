...
def process_data(input_data: InputModel):
    ...
    if input_data.file_b64:
        try:
            ...
            file_valid = True
            file_mime_type = mimetypes.guess_type("x." + imghdr.what(None, file_bytes))[0] or "application/octet-stream"
    ...
    return {
        "is_success": True,
        "user_id": "john_doe_17091999",  # Replace with yours
        "email": "john@xyz.com",         # Replace with yours
        "roll_number": "ABCD123",        # Replace with yours
        "numbers": numbers,
        "alphabets": alphabets,
